<template>
  <div class="wrapper" @downloadFile="downloadFile()">
    <div class="charts-section">
      ...
      <pie-chart v-if="vacanciesData.items.length > 0" class="chart" :options="options" :data="chartData"/>
...
export default {
  ...
  methods: {
    async loadStatistics() {
      ...
      const statisticsResponse = await this.getStatisticsByCategory(this.filter);
